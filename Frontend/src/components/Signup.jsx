...
function Signup() {
  ...
  return (
   <>
   <div className='flex h-screen items-center justify-center border-{2px} shadow-lg '>
...
<div className='mt-4 space-y-2'>
    <span>Email</span>
    <br />
    <input type='email' placeholder='Enter Your Mail' className='py-1 w-80 px-3 border rounded-md outline-none'
