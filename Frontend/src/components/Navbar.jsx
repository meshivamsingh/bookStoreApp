...
const[authUser,setAuthUser]=useAuth()
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer">Shivam BookStore</a>
  </div>
...

{
  authUser?(<Logout/>):(
    <div>
    <a className="bg-black px-3 py-2 cursor-pointer hover:bg-slate-800 text-white duration-300 rounded-md"
